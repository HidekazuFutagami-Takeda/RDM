...
<%-- ポータルボディー 開始 --%>
  ...
  <table id="formTable04" border="0" class="comPortalTable" align="center" style="width:75%; table-layout:fixed;">
	...
	<tr>
		...
		<td class="comFormTableItemNf012">
			<nobr>
                ...
                <s:textfield name="ultInsCd" id="ultInsCd" size="20" readonly="true" />
            </nobr>
		</td>
	</tr>
	<tr>
		...
		<td class="comFormTableItemNf012"><nobr><s:textfield name="shisetsuNmRyaku" size="30" maxlength="60" readonly="true" /></nobr></td>
	</tr>
	<tr>
	   	<td class="comFormTableItem">ULT施設名</td>
	   	<td class="comFormTableItemNf012"><s:label key="preShisetsuNm" /></td>
		<td class="comFormTableItemNf012"><nobr><s:textarea name="shisetsuNm" style="width:220px; height:40px; resize: none;" readonly="true" />　</nobr></td>
	</tr>
	</table>
	<br/>
	<hr class="comTitle" style="margin-top:2px;width:75%"/><br/>
	...
	<tr>
		...
		<td class="comFormTableItemNf012">
			<nobr>
                <s:textfield name="addrCodePrefName" id="addrCodePrefName" size="20" readonly="true" />
	...
	<tr>
		...
		<td class="comFormTableItemNf012">
			<nobr>
                <s:textfield name="addrCodeCityName" id="addrCodeCityName" size="20" readonly="true" />
	...
	<tr>
		...
		<td class="comFormTableItemNf012">
			<nobr>
                <s:textfield name="tkCityName" id="tkCityName" size="20" readonly="true" />
