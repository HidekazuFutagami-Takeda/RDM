...
import jp.co.takeda.rdm.service.ND315Service;
...
@Named("nD315Action")
@Scope("request")
public class ND315Action extends BaseAction<ND315DTO> {
     ...
     */
    @Inject
    private ND315Service nD315Service;
    // 確認画面用にする
    ...
    public String init() throws Exception {
        initSetup();
        // F層呼び出し
        BaseDTO outdto = nD315Service.init(dto);
    ...
    protected String initNext(BaseDTO outdto) throws Exception {
        ...
        sessionMap.put(AppConstant.SESKEY_ND315_SEARCHKEY, outdto);
        // END UOC
        setNextDTO(outdto);
    ...
    public String register() throws Exception {
        registerSetup();
        // F層呼び出し
        BaseDTO outdto = nD315Service.register(dto);
        if (outdto instanceof ND315DTO) {
            // START UOC
//            outdto = nD315Service.register(dto);
            // END UOC
        }
...
//        sessionMap.put(AppConstant.SESKEY_ND315_SEARCHKEY, searchKey);
    }
