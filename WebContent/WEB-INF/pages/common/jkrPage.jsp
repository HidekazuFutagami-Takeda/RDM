...
String showtReloadFlg  = request.getParameter("showtReloadFlg");
int showRoload = 0;
if (showtReloadFlg != null && showtReloadFlg.trim().length() !=0) {
    showRoload = Integer.parseInt(showtReloadFlg.trim());
}
%>
       ...
       <!-- 改ページ -->
        <table width="95%" >
            ...
            <tr align="right">
                <td>
                  <%if (showRoload == 1) { %>
                    <nobr><a class="comMiniLink" href="#" onClick="JavaScript:pltReload()">更新</a>&nbsp;&nbsp;</nobr>
                  <%} %>
                  <!-- 前頁リンク -->
