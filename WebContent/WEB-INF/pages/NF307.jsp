...
<head>
  ...
  <script type="text/javascript" src="js/catHcpPub.js"></script>
    ...
    function backBtn(){
    	if(window.confirm("施設復活画面へ戻ります。よろしいですか？（入力内容は破棄されます。）")){
    		// NF014_施設復活画面に遷移
...
<table border="0" class="comPortalTable" align="center" style="width:98%;">
  ...
  <s:hidden name="orderKbn" />
    ...
    <%-- 画面用パラメータ --%>
    <s:hidden name="backScreenId" value="NF307" />
...
<%-- ポータルタイトル 開始 --%>
    ...
    <tbody>
    <tr>
        <td class="comPortalTitleIcon"><img class="comSmallIcon" src="img/mrinsdoc.gif" alt="施設復活"></td>
...
<%-- ポータルボディー 開始 --%>
  ...
  <table id="formTable02" border="0" class="comPortalTable" align="center" style="width:75%;">
      ...
      <tr>
	      ...
	      <td class="comFormTableItem"><nobr><s:label key="insPcode"/></nobr></td>
	      <td class="comFormTableItem"><nobr>&nbsp;</nobr></td>
	      <td class="comFormTableItem"><nobr>&nbsp;</nobr></td>
      </tr>
      <tr>
	      ...
	      <td class="comFormTableItem" colspan=3><nobr><s:label key="insAddr"/></nobr></td>
      </tr>
      <tr>
	      <td class="comFormTableItem"><nobr>&nbsp;</nobr></td>
  ...
  <table id="formTable03" border="0" class="comPortalTable" align="center" style="width:75%;">
      ...
      <tr>
      	<s:if test='%{reqStsCd == null || reqStsCd == "" || reqStsCd == "01"}'>
	    	<td class="comFormTableItem"><nobr><s:textarea name="reqComment"  cols="50" rows="3" maxlength="300" style="width: 650px; height: 80px; background-color:#ffffff" readonly="true"/></nobr></td>
      	</s:if>
      	<s:else>
      ...
      <s:if test='%{loginJokenSetCd == "JKN0850"}'>
	      ...
	      <tr>
	      	...
	      	<s:else>
	      		<td class="comFormTableItem"><nobr><s:textarea name="aprComment"  cols="50" rows="3" maxlength="300" style="width: 650px; height: 80px;" readonly="true"/></nobr></td>
	      	</s:else>
	      </tr>
      </s:if>
  </table>
