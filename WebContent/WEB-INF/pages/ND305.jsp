...
<head>
  ...
  <script type="text/javascript" src="js/common.js"></script>
    ...
    function nd305Register(buttonFlg){
   	  // 確認メッセージ表示
   	  ...
   	  document.fm1.screenId.value = 'ND305';
...
<table border="0" class="comPortalTable" align="center" style="width:98%;">
  ...
  <s:hidden name="orderKbn" />
    ...
    <%-- 画面用パラメータ --%>
    <s:hidden name="backScreenId" value="ND305" />
...
<%-- ポータルタイトル 開始 --%>
    ...
    <tbody>
    <tr>
        <td class="comPortalTitleIcon"><img class="comSmallIcon" src="img/mrinsdoc.gif" alt="医師復活- 申請内容確認"></td>
  ...
  <hr class="comTitle" style="margin-top:2px;width:75%"/><br/>
    <table id="formTable03" border="0" class="comPortalTable" align="center" style="width:75%;">
      ...
      <tr>
	      ...
	      <td class="comFormTableItem"><nobr>医師固定コード</nobr></td>
      ...
      <tr>
	      ...
	      <td class="comFormTableItem"><nobr>
					      <s:label key="rstReasonNm"/>
			  <s:hidden name="rstReason"/><s:hidden name="rstReasonNm"/>
