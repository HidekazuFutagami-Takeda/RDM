 ...
 */
@Named
public class NC001Service extends BaseService {

    /**
     * ログインスタンス
     * @generated
     */
    private static Log log = LogFactory.getLog(NC001Service.class);

    /**
     * イベント処理
     * @param indto NC001DTO
     * @return 遷移先DTO
     * @customizable
     */
    @Transactional
    public BaseDTO init(NC001DTO indto) {
