 ...
 * @version Ver00-01
 */
public class AccessControlHttpHeader_back implements Filter {
     ...
     * @generated
     */
    private static Log log = LogFactory.getLog(AccessControlHttpHeader_back.class);
...
//2020.05.04 Hitachi Hagimoto ユーザIDをアクセストークンから取得する方式に変更 ADD_END
	        ...
	        if (urlName.contains("JKR000C010Init")) {
