      	  ...
      	  <s:else>
              ...
              <%-- ヘッダー行 --%>
												<tr>
													...
													<td class="comTableTitle container"
														style="width: 30px; border: none;">種別 <span
														style="font-size: 1pt;"> </span> <a
													...
													<td class="comTableTitle container"
														style="width: 80px; border: none;">施設／医師固定C</td>
													<td class="comTableTitle container"
														style="width: 80px; border: none;">施設／医師名</td>
													<td class="comTableTitle container"
														style="width: 70px; border: none;">申請者 <span
														style="font-size: 1pt;"> </span> <a
													...
													<td class="comTableTitle container"
														style="width: 80px; border: none;">申請者所属</td>
													<td class="comTableTitle container"
														style="width: 80px; border: none;">申請コメント</td>
													<s:if test='mrAdminFlg == "1"'>
														<td class="comTableTitle container"
															style="width: 30px; border: none;">審査</td>
														<td class="comTableTitle container"
															style="width: 80px; border: none;">審査日時</td>
														<td class="comTableTitle container"
															style="width: 80px; border: none;">審査者</td>
													</s:if>
													<td class="comTableTitle container"
														style="width: 80px; border: none;">承認日時</td>
													<td class="comTableTitle container"
														style="width: 80px; border: none;">承認者</td>
													<td class="comTableTitle container"
														style="width: 80px; border: none;">審査・承認メモ</td>
													<td class="comTableTitle container"
														style="width: 80px; border: none;">承認・却下コメント</td>
													<s:if test='mrAdminFlg == "1"'>
														<td class="comTableTitle container"
															style="width: 30px; border: none;">FB申請要否</td>
														<td class="comTableTitle container"
															style="width: 80px; border: none;">FB回答</td>
														<td class="comTableTitle container"
															style="width: 30px; border: none;">FB処理区分</td>
													</s:if>
												</tr>
												<%-- 内容 --%>
