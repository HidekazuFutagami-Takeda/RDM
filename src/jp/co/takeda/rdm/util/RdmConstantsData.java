...
//    public static final String RDM_JKN_HONBU_COMMIT = "JKN0163";
    ...
    /**パラメタ情報パラメタ名 : 画面利用警告表示時間 */
    public static final String PARAM_NAME_TIME_LIMIT = "TIME_LIMIT";
    ...
    public static final String W072 = "W072"; // 削除する医師と重複医師の医師固定コードが同一です。
    public static final String W073 = "W073"; // 勤務先が廃院のため申請できません。
