            ...
            <td style="padding:20px 80px 0px 80px;">
              <table border="0" align="center">
                <tr>
                  ...
                  <td nowrap style="color:#336699;font-weight:bold;">メニュー利用権限がありません</td>
                </tr>
              </table>
            </td>
          </tr>
          <tr>
            <td style="padding:15px 80px 0px 40px;">
              <s:if test="#request.AuthorizationServiceData.scrnName !=null && #request.AuthorizationServiceData.scrnName != ''">
              <table border="0" align="center">
                <tr>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  ...
                  <td style="font-size:8pt;">
                    <s:property value="#request.AuthorizationServiceData.scrnName"/>
                  </td>
                </tr>
              </table>
              </s:if>
