...
<table border="0" class="comPortalTable" align="center" style="width:98%;">
  ...
  <s:hidden name="orderKbn" />
    ...
    <%-- 画面用パラメータ --%>
    <s:hidden name="backScreenId" value="NF014" />
  ...
  <table id="formTable02" border="0" class="comPortalTable" align="center" style="width:75%;">
      ...
      <tr>
	      ...
	      <td class="comFormTableItem"><nobr>
	      	<s:select id="rstReason" name="rstReason" cssStyle="width:130pt" list="rstReasonCombo"/>
	      	<s:textfield id="rstReasonView" name="rstReasonView" cssStyle="width:130pt" readonly="true" />
	      </nobr></td>
	      <td class="comFormTableItem"><nobr>&nbsp;</nobr></td>
	      <td class="comFormTableItem"><nobr>&nbsp;</nobr></td>
      </tr>
