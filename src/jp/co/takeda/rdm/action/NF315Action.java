...
@Named("nF315Action")
@Scope("request")
public class NF315Action extends BaseAction<NF315DTO> {
    ...
    public String init() throws Exception {
        initSetup();
        // F層呼び出し
        BaseDTO outdto = nF315Service.init(dto);
    ...
    public String register() throws Exception {
    	registerSetup();
        // F層呼び出し
        BaseDTO outdto = nF315Service.register(dto);
    ...
    public String apprRej() throws Exception {
        apprRejSetup();
        // F層呼び出し
        BaseDTO outdto = nF315Service.apprRej(dto);
    ...
    protected void apprRejSetup() throws Exception {
        ...
        dto.setMsgId(null);
        // 画面タイトル制御処理
        String title = "NF315_施設紐付け変更 - 申請内容確認";
        dto.setTitle(title);
        // END UOC
    }
