...
//        dto.setSelectListChange("0");
	...
	public String search() throws Exception {
		...
		// 必須検索条件が未入力の場合
		if (StringUtils.isEmpty(dto.getKensakuDocKanj()) && StringUtils.isEmpty(dto.getKensakuDocKana())
				&& StringUtils.isEmpty(dto.getKensakuDocType()) && StringUtils.isEmpty(dto.getKensakuDocNo())
				&& StringUtils.isEmpty(dto.getKensakuUltDocNo()) && StringUtils.isEmpty(dto.getKensakuDocAttribute())
				&& StringUtils.isEmpty(dto.getKensakuMedSch()) && StringUtils.isEmpty(dto.getKensakuGradYear())
				&& StringUtils.isEmpty(dto.getKensakuHuniv()) && StringUtils.isEmpty(dto.getKensakuSTantouBrCode())
				&& dto.getKensakuJgiNo() == 0 && StringUtils.isEmpty(dto.getKensakuShinseiBrCode())
				&& StringUtils.isEmpty(dto.getKensakuInsNo()) && StringUtils.isEmpty(dto.getKensakuInsKanj())
				&& StringUtils.isEmpty(dto.getKensakuReqJgiName()) && StringUtils.isEmpty(dto.getKensakuUpdMstFrom())
		...
		if (!StringUtils.isEmpty(dto.getKensakuUpdMstFrom()) && !StringUtils.isEmpty(dto.getKensakuUpdMstTo())
				&& !dto.getKensakuUpdMstFrom().equals(dto.getKensakuUpdMstTo())
