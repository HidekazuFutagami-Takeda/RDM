 ...
 * SQLID : selectCntHcp
 */
public class SelectPageHcoUpdHstEntity extends BaseEntity implements Serializable {
     ...
     * コンストラクタ
     */
    public SelectPageHcoUpdHstEntity() {
        super("m_rdm_hco_upd_hst_mst" , "selectCntHcp");
    }
