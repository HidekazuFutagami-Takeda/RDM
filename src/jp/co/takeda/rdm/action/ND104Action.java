	...
	public String init() throws Exception {
		...
		if (!"ND313".equals(preScreenId)) {
			...
			if (Objects.deepEquals(dto.getShinseiButtonFlg(), "1")) {
				...
				//
				// Integer nextBizDay =
				// Integer.parseInt(rdmCommonEntityList.get(0).getNextBizday());
				...
				// TRdmReqKnrEntity tRdmReqKnrChkEntity = new
				// TRdmReqKnrEntity("selectNF011DateChkData");
				// tRdmReqKnrChkEntity.setReqId(dto.getParamReqId());
				//
				// List<TRdmReqKnrEntity> tRdmReqKnrEntityList =
				// dao.select(tRdmReqKnrChkEntity);
				//
