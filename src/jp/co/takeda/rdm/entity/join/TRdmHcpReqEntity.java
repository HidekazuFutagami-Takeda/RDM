...
public class TRdmHcpReqEntity extends BaseEntity implements Serializable {
    ...
    private boolean spComCdNullFlag;
    ...
    private boolean skJobFromNullFlag;
	...
	/**
	 * TRdmHcpReqEntity.javaspComCdを設定
	 * @return spComCd
	 */
	...
	/**
	 * TRdmHcpReqEntity.javaspComCdNullFlagを設定
	 * @return spComCdNullFlag
	 */
	public boolean isSpComCdNullFlag() {
		return spComCdNullFlag;
	}
	...
	/**
	 * @param spComCdNullFlag セットする spComCdNullFlag
	 */
	public void setSpComCdNullFlag(boolean spComCdNullFlag) {
		this.spComCdNullFlag = spComCdNullFlag;
	}
	...
	/**
	 * TRdmHcpReqEntity.javaskJobFromを設定
	 * @return skJobFrom
	 */
	...
	/**
	 * TRdmHcpReqEntity.javaskJobFromNullFlagを設定
	 * @return skJobFromNullFlag
	 */
	public boolean isSkJobFromNullFlag() {
		return skJobFromNullFlag;
	}
	...
	/**
	 * @param skJobFromNullFlag セットする skJobFromNullFlag
	 */
	public void setSkJobFromNullFlag(boolean skJobFromNullFlag) {
		this.skJobFromNullFlag = skJobFromNullFlag;
	}
