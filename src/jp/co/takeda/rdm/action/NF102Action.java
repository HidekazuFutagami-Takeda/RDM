...
import jp.co.takeda.rdm.service.NF102Service;
...
@Named("nF102Action")
@Scope("request")
public class NF102Action extends BaseAction<NF102DTO> {
     ...
     */
    @Inject
    private NF102Service NF102Service;
  ...
  //ログインユーザ情報取得
    ...
    public String init() throws Exception {
        initSetup();
        // F層呼び出し
        BaseDTO outdto = NF102Service.init(dto);
    ...
    protected void initSetup() throws Exception {
        // START UOC
    	// 画面タイトル制御処理
        String title = "NF102_施設来期情報更新 - 申請歴";
    ...
    protected String initNext(BaseDTO outdto) throws Exception {
    	...
    	sessionMap.put(AppConstant.SESKEY_NF102_SEARCHKEY, outdto);
        // END UOC
        setNextDTO(outdto);
