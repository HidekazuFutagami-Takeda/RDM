...
<body class="comPage" onUnload="JavaScript:jmrUnLoad();" onLoad="JavaScript:comSetFormWindowInfo();">
    ...
    <s:form name="fm1" theme="simple" onSubmit="JavaScript:return false;" >
          ...
          <input type="hidden" name="selectFlgPop" value="1" />
          ...
          <s:hidden name="upSosCode"/>
          <s:hidden name="upBumonRank"/>
          <s:hidden name="upBrCode"/>
          <s:hidden name="upDistCode"/>
          <s:hidden name="jgiNo"/>
...
%>
          ...
          <s:else>
              <div style="height:300px;width:1250px;overflow-y:scroll; overflow-x:scroll; border-width:1px; position: relative; top:0; margin:0 auto;">
