...
import jp.co.takeda.jkr.entity.MRdmFwHelperMatrixEntity;
import jp.co.takeda.jkr.entity.MRdmFwTransitionEntity;
        ...
        if (!loginInfo.isJgiNameGetFlag()) {
            ...
            if (!loginInfo.isJgiNameGetFlag()) {
                ...
                if (!loginInfo.isActing()) {
                    //受け取る文字は必ず７桁のC123456
                    if(userId != null && jp.co.takeda.jkr.util.StringUtils.getByteLength(userId) == 7 && jp.co.takeda.jkr.util.StringUtils.isSingleByte(userId)) {
