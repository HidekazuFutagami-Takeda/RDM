...
<html>
<head>
  <title>NF313_施設紐付け変更 - 申請内容確認</title>
  ...
  <script type="text/javascript" src="js/catHcpPub.js"></script>
    ...
    // 戻るボタン
    function backBtn(){
    	//if(window.confirm("施設紐付け変更画面へ戻ります。よろしいですか？（入力内容は破棄されます。）")){
    		// NF212_施設紐付け変更に遷移
    		document.fm1.screenId.value="NF212";
    ...
    function rejectBtn(){
    	if(window.confirm("申請データを却下します。よろしいですか？")){
			...
			// NC011_申請一覧へ遷移する
    		document.fm1.screenId.value="NF313";
...
<table id="formTable" border="0" class="comPortalTable" align="center" style="width:98%;">
  ...
  <s:hidden name="orderKbn" />
    ...
    <%-- 画面用パラメータ --%>
    <s:hidden name="backScreenId" value="NF313" />
...
<%-- ポータルボディー 開始 --%>
  ...
  <table id="formTable01" border="0" <s:if test='tkdTrtKbn == "0"'>class="comPortalTableBlue"</s:if><s:else>class="comPortalTable"</s:else> align="center" style="width:75%;">
      ...
      <tr>
	      <td <s:if test='tkdTrtKbn == "0"'>class="comFormTableItemBlue"</s:if><s:else>class="comFormTableItem"</s:else>><nobr>&nbsp;</nobr></td>
	      <td <s:if test='tkdTrtKbn == "0"'>class="comFormTableItemBlue"</s:if><s:else>class="comFormTableItem"</s:else>><nobr>申請者所属</nobr></td>
      ...
      <tr>
	      <td <s:if test='tkdTrtKbn == "0"'>class="comFormTableItemBlue"</s:if><s:else>class="comFormTableItem"</s:else>><nobr>&nbsp;</nobr></td>
	      <td <s:if test='tkdTrtKbn == "0"'>class="comFormTableItemBlue"</s:if><s:else>class="comFormTableItem"</s:else>><nobr>申請者氏名</nobr></td>
	  ...
	  <s:if test='%{reqStsCd != null && reqStsCd != "" && !(reqStsCd == "01" || reqStsCd == "11" || reqStsCd == "03" || reqStsCd == "13") }'>
		<s:if test='%{loginJgiNo != reqJgiNo }'>
	      <tr>
		      <td <s:if test='tkdTrtKbn == "0"'>class="comFormTableItemBlue"</s:if><s:else>class="comFormTableItem"</s:else>><nobr>&nbsp;</nobr></td>
		      <td <s:if test='tkdTrtKbn == "0"'>class="comFormTableItemBlue"</s:if><s:else>class="comFormTableItem"</s:else>><nobr>審査者氏名</nobr></td>
      ...
      <tr>
	      <td <s:if test='tkdTrtKbn == "0"'>class="comFormTableItemBlue"</s:if><s:else>class="comFormTableItem"</s:else>><nobr>&nbsp;</nobr></td>
	      <td <s:if test='tkdTrtKbn == "0"'>class="comFormTableItemBlue"</s:if><s:else>class="comFormTableItem"</s:else>><nobr>承認者氏名</nobr></td>
  ...
  <table id="formTable02" border="0" <s:if test='tkdTrtKbn == "0"'>class="comPortalTableBlue"</s:if><s:else>class="comPortalTable"</s:else> align="center" style="width:75%;">
	...
	<table id="formTable03" border="0" <s:if test='tkdTrtKbn == "0"'>class="comPortalTableBlue"</s:if><s:else>class="comPortalTable"</s:else> align="center" style="width:75%;">
      ...
      <tr>
	      ...
	      <td <s:if test='tkdTrtKbn == "0"'>class="comFormTableItemBlue"</s:if><s:else>class="comFormTableItem"</s:else>><nobr>施設略式漢字名</nobr></td>
	      <td <s:if test='tkdTrtKbn == "0"'>class="comFormTableItemBlueNf212Right"</s:if><s:else>class="comFormTableItemNf212Right"</s:else>><nobr><s:label key="mainInsNm" /></nobr></td>
      </tr>
      <tr>
	      <td <s:if test='tkdTrtKbn == "0"'>class="comFormTableItemBlue"</s:if><s:else>class="comFormTableItem"</s:else>><nobr>&nbsp;</nobr></td>
	      ...
	      <td <s:if test='tkdTrtKbn == "0"'>class="comFormTableItemBlueNf212Foot3"</s:if><s:else>class="comFormTableItemNf212Right"</s:else>><s:label key="mainInsAddr" /></td>
      </tr>
      ...
      <tr>
		...
		<tr>
			<td <s:if test='tkdTrtKbn == "0"'>class="comFormTableItemBlue"</s:if><s:else>class="comFormTableItem"</s:else>><nobr>&nbsp;</nobr></td>
 	    	...
 	    	<td <s:if test='tkdTrtKbn == "0"'>class="comFormTableItemBlue"</s:if><s:else>class="comFormTableItem"</s:else>><nobr><s:label key="tekiyoYmd" /><s:hidden name="tekiyoYmd" /></nobr></td>
 	    	<td <s:if test='tkdTrtKbn == "0"'>class="comFormTableItemBlue"</s:if><s:else>class="comFormTableItem"</s:else>><nobr>&nbsp;</nobr></td>
 	    	<td <s:if test='tkdTrtKbn == "0"'>class="comFormTableItemBlue"</s:if><s:else>class="comFormTableItem"</s:else>><nobr>&nbsp;</nobr></td>
		</tr>
	</table>
  ...
  <%--コメント類 --%>
  <table id="formTable05" border="0" <s:if test='tkdTrtKbn == "0"'>class="comPortalTableBlue"</s:if><s:else>class="comPortalTable"</s:else> align="center" style="width:75%;">
      <tr>
        <%--コメント--%>
      ...
      <tr>
    	<s:if test='%{reqStsCd == null || reqStsCd == "" || reqStsCd == "01"}'>
	    	<td <s:if test='tkdTrtKbn == "0"'>class="comFormTableItemBlue"</s:if><s:else>class="comFormTableItem"</s:else>><nobr><s:textarea name="reqComment"  cols="50" rows="3" maxlength="300" style="width: 650px; height: 80px;" readonly="true"/></nobr></td>
      	</s:if>
      	<s:else>
	    	<td <s:if test='tkdTrtKbn == "0"'>class="comFormTableItemBlue"</s:if><s:else>class="comFormTableItem"</s:else>><nobr><s:textarea name="reqComment"  cols="50" rows="3" maxlength="300" style="width: 650px; height: 80px;" cssClass="mediumGray" readonly="true"/></nobr></td>
      	</s:else>
      </tr>
      <s:if test='%{loginJokenSetCd == "JKN0850"}'>
	      ...
	      <tr>
	      	...
	      	<s:else>
	      		<td <s:if test='tkdTrtKbn == "0"'>class="comFormTableItemBlue"</s:if><s:else>class="comFormTableItem"</s:else>><nobr><s:textarea name="aprComment"  cols="50" rows="3" maxlength="300" style="width: 650px; height: 80px;" cssClass="mediumGray" readonly="true"/></nobr></td>
	      	</s:else>
	      </tr>
      </s:if>
  </table>
  ...
  <%--ボタン類 --%>
  <table id="formTable06" border="0" <s:if test='tkdTrtKbn == "0"'>class="comPortalTableBlue"</s:if><s:else>class="comPortalTable"</s:else> align="center" style="width:98%;">
      <tr>
