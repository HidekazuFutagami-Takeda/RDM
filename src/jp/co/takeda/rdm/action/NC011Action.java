...
import jp.co.takeda.rdm.service.NC011Service;
...
@Named("nC011Action")
@Scope("request")
public class NC011Action extends BaseAction<NC011DTO> {
     ...
     */
    @Inject
    private NC011Service NC011Service;
...
//    }
    ...
    public String init() throws Exception {
        initSetup();
        // F層呼び出し
        BaseDTO outdto = NC011Service.init(dto);
...
//        dto.setMsgId(null);
    ...
    public String sort() throws Exception {
        pageSetup();
        // F層呼び出し
        BaseDTO outdto = NC011Service.sort(dto);
...
//        }
    ...
    protected String sortNext(BaseDTO outdto) throws Exception {
        // START UOC
        sessionMap.put(AppConstant.SESKEY_NC011_SEARCHKEY, outdto);
        // END UOC
        setNextDTO(outdto);
    ...
    public String page() throws Exception {
        pageSetup();
        // F層呼び出し
        BaseDTO outdto = NC011Service.page(dto);
        if (outdto instanceof NC011DTO) {            // START UOC
//        	// チェック済み再設定
...
//            }
    ...
    protected void pageSetup() throws Exception {
        // START UOC
    	this.setSearchCon();
        NC011DTO searchKey = (NC011DTO)sessionMap.get(AppConstant.SESKEY_NC011_SEARCHKEY);
        // 所属部科名カナ
