...
//              //検索結果_ （来期）項目変更フラグ
                //下記項目のいずれかが'1'なら
                if (    Objects.equals(entity.getHoInsTypeUpdFlg(), "1")
...
//                dataRecord.setOtherChanges(entity.getOtherChanges());
              ...
              //更新フラグがない場合　画面表示しない
                if (!Objects.equals(entity.getHoInsTypeUpdFlg(), "1")
                 && !Objects.equals(entity.getInsAbbrNameUpdFlg(), "1")
                 ...
                 && !Objects.equals(entity.getInsFax2UpdFlg(), "1")
                 && !Objects.equals(entity.getInsUrlUpdFlg(), "1")
                 ...
                 && !Objects.equals(entity.getBedcnt01UpdFlg(), "1")
                 && Objects.equals(dataRecord.getHcoNxt(), "")
                		) {
                	continue;
                }
