 ...
 * SQLID : selectCntHcp
 */
public class SelectCntSelectReqListEntity extends BaseEntity implements Serializable {
     ...
     * コンストラクタ
     */
    public SelectCntSelectReqListEntity() {
        super("t-rdm-req-knr" , "countReqKnr");
    }
