 ...
 * @generated
 */
public class NF212DTO extends BaseDTO implements Serializable {
     ...
     * @generated
     */
    public void setNF212(String screenID){
        this.NF212 = screenID;
    }
     ...
     * @generated
     */
    public String getNF212(){
        return NF212;
    }

	/**
	 * NF212DTO.javamsgIdを設定
	 * @return msgId
	 */
	...
	/**
	 * NF212DTO.javaloginJokenSetCdを設定
	...
	/**
	 * NF212DTO.javapreMainInsAddrを設定
	...
	/**
	 * NF212DTO.javapreMainInsSbtを設定
	 * @return preMainInsSbt
	 */
	public String getPreMainInsSbt() {
		return preMainInsSbt;
	}

	/**
	 * @param preMainInsSbt セットする preMainInsSbt
	 */
	public void setPreMainInsSbt(String preMainInsSbt) {
		this.preMainInsSbt = preMainInsSbt;
	}

	/**
	 * NF212DTO.javainsSbtAfを設定
	 * @return insSbtAf
	 */
	...
	/**
	 * NF212DTO.javapreInsTantoを設定
	 * @return preInsTanto
	 */
	public String getPreInsTanto() {
		return preInsTanto;
	}

	/**
	 * @param preInsTanto セットする preInsTanto
	 */
	public void setPreInsTanto(String preInsTanto) {
		this.preInsTanto = preInsTanto;
	}

	/**
	 * NF212DTO.javalnkTrtDataListを設定
	...
	/**
	 * NF212DTO.javatrtPrdGrpComboを設定
