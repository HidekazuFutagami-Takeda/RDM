 ...
 * @author 日立　花
 */
public class JkrConstantsData {

    /***条件設定 : 適用日設定可能本部権限 */
    public static final String JKR_JKN_HONBU_COMMIT = "JKN0163";

    /***条件設定 : 適用日設定不可本部権限 */
    public static final String JKR_JKN_HONBU_NOCOMMIT = "JKN0162";

    /**条件設定 : ワクチンG権限 */
    public static final String JKR_JKN_VACCINE = "JKN0161";

    /**条件設定 : 支店権限 */
    public static final String JKR_JKN_SITEN = "JKN0160";

    /**条件設定 : 営業所権限 */
    public static final String JKR_JKN_EIGYOU = "JKN0159";

    /**条件設定 : ＯＮＣＧＭ権限 */
    public static final String JKR_JKN_ONCGM = "JKN0337";

    /**条件設定 : MR権限 */
    public static final String JKR_JKN_MR = "JKN0164";

    //20180118 HISOL Kawamoto JKR-C-005 MOD START
    //20150127 HISOL Suzuki 期末期首 組織変更対応 ADD START
    ///**条件設定 : ONC営業部スタッフ権限 */
    //public static final String JKR_JKN_ONC = "JKN0349";
    /**条件設定 : 従業員関連・営業部Ｓ権限 */
    public static final String JKR_JKN_ONC = "JKN0501";
    //20150127 HISOL Suzuki 期末期首 組織変更対応 ADD END
    //20180118 HISOL Kawamoto JKR-C-005 MOD END

    //20150618 HISOL Oshita JKR_TOP_DISP_CTRL_組織グループ追加 ADD START
    /**条件設定 : ONC営業部長権限 */
    public static final String JKR_JKN_ONCM = "JKN0372";
    //20150618 HISOL Oshita JKR_TOP_DISP_CTRL_組織グループ追加 ADD END
    ...
    /**従業員関連テーブル名 : 担当引継ぎ情報 */
    public static final String JKR_CHG_BYMR = "jkr_chg_bymr";

    /**従業員関連テーブル名 : 医師別担当変更情報 */
    public static final String JKR_CHG_BYDOC = "jkr_chg_bydoc";

    /**従業員関連テーブル名 : 施設別担当変更情報 */
    public static final String JKR_CHG_BYINS = "jkr_chg_byins";

    /**従業員関連テーブル名 : 施設変更市区郡集約情報 */
    public static final String JKR_CHG_GRAD = "jkr_chg_grad";

    /**従業員関連テーブル名 : 医師変更所属部科集約情報 */
    public static final String JKR_CHG_GRDEPT = "jkr_chg_grdept";

    /**従業員関連テーブル名 : 従業員関連汎用マスタ */
    public static final String JKR_CD_MST  = "jkr_cd_mst ";

    /**従業員関連テーブル名 : MR担当地区情報 */
    public static final String JKR_MR_ADDR = "jkr_mr_addr";

    /**従業員関連テーブル名 : MR施設(従業員関連) */
    public static final String JKR_MR_INS = "jkr_mr_ins";

    /**従業員関連テーブル名 : MR施設医師(従業員関連) */
    public static final String JKR_MR_INS_DOC = "jkr_mr_ins_doc";

    /**従業員関連テーブル名 : 従業員関連MSGマスタ */
    public static final String JKR_MSG_MST = "jkr_msg_mst";

    /**従業員関連テーブル名 : 従業員関連PDFデータ */
    public static final String JKR_PDF_DATA = "jkr_pdf_data";

    /**従業員関連テーブル名 : 組織担当地区情報 */
    public static final String JKR_SOS_ADDR = "jkr_sos_addr";

    /**従業員関連テーブル名 : 専門MR営MR組織関連 */
    public static final String JKR_SOS_REL = "jkr_sos_rel";

    /**従業員関連テーブル名 : 担当変更状況 */
    public static final String JKR_SOS_STS = "jkr_sos_sts";
    ...
    public static final String JKR_CHG_ERRCNT = "jkr_chg_errcnt";

    /**従業員関連パッケージ・プロシージャ名 : 担当引継ぎ作成プロシージャ名 */
    public static final String PROCEDURE_MAKE_CHG_BYMR = "jkr_common.make_chg_bymr";

    /**従業員関連パッケージ・プロシージャ名 : 施設武田市区郡集約作成プロシージャ名 */
    public static final String PROCEDURE_MAKE_CHG_GRAD = "jkr_common.make_chg_grad";

    /**従業員関連パッケージ・プロシージャ名 : 医師所属部科集約作成プロシージャ名 */
    public static final String PROCEDURE_MAKE_CHG_GRADEPT = "jkr_common.make_chg_grdept";

    /**従業員関連パッケージ・プロシージャ名 : 仮従業員登録　MR連番最大値取得プロシージャ名 */
    public static final String PROCEDURE_GET_MAX_KNO = "jkr_common.get_max_kno";

    /**MR種類コード : 営MRコード */
    public static final String JKR_MRCAT_EIGYOU = "01";

    /**MR種類コード : CVMコード */
    public static final String JKR_MRCAT_CVM = "08";

    /**MR種類コード : RSコード */
    public static final String JKR_MRCAT_RS = "09";

    /**MR種類コード : ワクチンMRコード */
    public static final String JKR_MRCAT_VAC = "02";

    /**MR種類コード : EMRコード */
    public static final String JKR_MRCAT_EMR = "04";

    /**MR種類コード : LMRコード */
    public static final String JKR_MRCAT_LMR = "05";

    /**MR種類コード : SCコード */
    public static final String JKR_MRCAT_SC = "06";

    /**MR種類コード : 整形MR */
    public static final String JKR_MRCAT_SEIKEI = "07";

    /**状況 : 変更中 */
    public static final String JKR_STATUS_CHANGE = "20";

    /**退避値 : String型 */
    public static final String JKR_ESCAPE_STR = "9999999";

    /**退避値 : int型 */
    public static final int JKR_ESCAPE_INT = 9999999;

    /**String型 */
    public static final String JKR_KONMA = ",";

    /**String型 */
    public static final String JKR_RN = "\r\n";

    /**従業員関連パッケージ・プロシージャ名 : 担当変更状況(新組織) */
    public static final String PROCEDURE_UPDATE_TOSOS_STS = "jkr_common.update_tosos_sts";

    /**従業員関連パッケージ・プロシージャ名 : 解除ボタン押下時の担当変更状況(新組織) */
    public static final String PROCEDURE_UPDATE_TOSOS_STS_REMOVE = "jkr_common.update_tosos_sts_remove";

    /**従業員関連パッケージ名 : 登録ボタン押下時(担当引継ぎ・施設別担当変更・医師別担当変更) */
    public static final String JKR_CHECK = "jkr_check.proc_main";

    public static final String JKR_CHECK_TOSOS = "jkr_check.proc_main_tosos";

    /***2014年4月医薬組織変更・期末期首対応（従業員関連）*/
    public static final String JKR_CHG_ATSET = "jkr_chg_atset.mkat_mrcyi";
    ...
    /** 担当変更システムトップメニュー[リスト作成依頼]ボタン押下 : 戻るためのDTOセッション格納キー */
    public static final String JKR000C010_RETURN_DTO_KEY = "JKR000C010_RETURN_DTO_KEY";
    ...
    public static final String SCREEN_ID_JKR000C010 = "JKR000C010";
